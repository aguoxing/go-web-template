...
type SysRole struct {
	...
	MenuCheckStrictly *int64     `gorm:"column:menu_check_strictly;type:tinyint(1);default:1" json:"menuCheckStrictly"` // 菜单树选择项是否关联显示
	DeptCheckStrictly *int64     `gorm:"column:dept_check_strictly;type:tinyint(1);default:1" json:"deptCheckStrictly"` // 部门树选择项是否关联显示
